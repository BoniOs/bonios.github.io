...
$(function() {
  $("li").on("click",function() {
	  if(this.id=="dnt") {
		  $("#dnt_txt").html("Bạn có thể ủng hộ USD qua thư PayPal: cuibaphn1"+"@"+"gmail.com");
	  }
  });
});
function loadPackageInfo() {
	...
	if (navigator.userAgent.search(/Cydia/) == -1) {
		$("#showAddRepo_").show();
		$("#open_cydia").attr("href","cydia://url/https://cydia.saurik.com/api/share#?source=https://bonios/github.io/repo&package="+urlSelfParts[1]);
	}
	$.ajax({
		url: form_url,
		type: "GET",
